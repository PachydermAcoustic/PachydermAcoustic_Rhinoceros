...
namespace Pachyderm_Acoustic
{
    namespace Numeric
    {
        ...
        {
            public class Acoustic_FDTD_complex : Simulation_Type
            {
                Polygon_Scene Rm;
                ...
                Acoustic_FDTD_complex.P_Node[, ,] PFrame;            //pressure scalar field initialisation
                Acoustic_FDTD_complex.U_Node[, ,] UFrameX;
                Acoustic_FDTD_complex.U_Node[, ,] UFrameY;
                Acoustic_FDTD_complex.U_Node[, ,] UFrameZ;

                double fmax = 300;
                Hare.Geometry.AABB Bounds;
                public Signal_Driver_complex SD;
                public Microphone_complex Mic;
                public Rhino.Geometry.Mesh m_templateX, m_templateY, m_templateZ;
                public int n;
                double time_ms;

                public Acoustic_FDTD_complex(Polygon_Scene Rm_in, ref Signal_Driver_complex S_in, ref Microphone_complex M_in, double fmax_in, double tmax_in)
                {
                    Rm = Rm_in;
                    SD = S_in;
                    Mic = M_in;
                ...
                public void Pressure_Points(ref List<List<Rhino.Geometry.Point3d>> Pts, ref List<List<System.Numerics.Complex>> Pressure, int[] X, int[] Y, int[] Z, double Low_P, bool Volume, bool Vectored, bool Colored)
                {
                ...
                {
                    public System.Numerics.Complex U;
                    public P_Node N1;
                    public P_Node N2;

                    public U_Node() { }
                    public abstract void Update();
                    public virtual System.Numerics.Complex U1
                    {
                        get { return U; }
                    }
                    public virtual System.Numerics.Complex U2
                    {
                        get { return U; }
                    }
                }
                ...
                //public class Bound_Node : Acoustic_FDTD_complex.U_Node
                //{
                //    //Botteldooren Boundary Node.
                //    Complex U1_Sum, U2_Sum;
                //    double KT;
                //    double alpha;
                //    double betacoef;
                //    Complex Uminus;
                ...
                //    public override System.Numerics.Complex U1
                //    {
                //        get
                //        {
                //            return Uminus;
                ...
                public class Bound_Node : Acoustic_FDTD_complex.U_Node
                {
                    ...
                    System.Numerics.Complex U1_Sum, U2_Sum;
                    double KT;
                    double alpha;
                    double betacoef;
                    System.Numerics.Complex Uminus;
                ...
                public class P_Node
                {
                    ...
                    public Point Pt;
                    public System.Numerics.Complex Pa;
                    ...
                    {
                        Rhino.Geometry.Vector3d V = new Rhino.Geometry.Vector3d((Xpos_Link.U - Xneg_Link.U).Magnitude, (Ypos_Link.U - Yneg_Link.U).Magnitude, (Zpos_Link.U - Zneg_Link.U).Magnitude);
                        V.Unitize();
                        return V;
                    }
            ...
            public class Signal_Driver_complex
            {
                Acoustic_FDTD_complex.P_Node[] SrcNode;
                double[] signal;
                double f;
                ...
                public Signal_Driver_complex(Signal_Type S_in, double freq, double w_in, Rhino.Geometry.Point3d[] Loc_in, double Delay)
                {
                    delay = Delay;
                    S = S_in;
                    f = freq;
                ...
                public void Connect_Grid(Acoustic_FDTD_complex.P_Node[, ,] Frame, AABB Bounds, double dx, double tmax, double dt)
                {
                    ...
                    SrcNode = new Acoustic_FDTD_complex.P_Node[Loc.Length];
                ...
                {
                    foreach (Acoustic_FDTD_complex.P_Node n in SrcNode)
                    {
            ...
            public class Microphone_complex
            {
                System.Numerics.Complex[][] recording;
                Acoustic_FDTD_complex.P_Node[] RecNode;
                Rhino.Geometry.Point3d[] Loc;

                public Microphone_complex(Rhino.Geometry.Point3d[] Loc_in)
                {
                    Loc = Loc_in;
                    Random R = new Random();
                    recording = new System.Numerics.Complex[Loc.Length][];
                    RecNode = new Acoustic_FDTD_complex.P_Node[Loc.Length];
                }
